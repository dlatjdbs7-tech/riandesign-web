  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-[1fr_340px]">
        ...
        {canManage && (
          <form action={createTransaction} className="flex h-fit flex-col gap-4 rounded-sm border border-nude/60 bg-white p-6">
            ...
            <input name="transaction_date" type="date" defaultValue={new Date().toISOString().slice(0, 10)} className="border-b border-nude bg-transparent py-2 text-sm outline-none focus:border-gold" />
